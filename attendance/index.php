...
<head>
  ...
  <title>Посещаемость — СВГТК Портал</title>
...
<aside class="sidebar" id="sidebar">
  <div class="sidebar-header">
    <div class="logo">
      ...
      <div class="logo-text"><span class="logo-title">СВГТК Портал</span><span class="logo-sub">Посещаемость</span></div>
    </div>
...
<div class="main-wrapper" id="mainWrapper">
  <header class="topbar">
    <div class="topbar-left">
      <div class="breadcrumb">
        ...
        <span class="breadcrumb-current">Посещаемость</span>
      </div>
    </div>
  ...
  <main class="page-content" style="display:flex;align-items:center;justify-content:center;min-height:calc(100vh - var(--topbar-height))">
    <div style="text-align:center;max-width:480px">
      <div style="width:80px;height:80px;border-radius:20px;background:#16a34a20;display:flex;align-items:center;justify-content:center;margin:0 auto 1.5rem">
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#16a34a" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
      </div>
      <h1 style="font-family:var(--font-display);font-size:1.75rem;font-weight:700;color:var(--color-text);margin-bottom:.75rem">Посещаемость</h1>
      <p style="font-size:1rem;color:var(--color-text-muted);margin-bottom:.5rem">Тема 1 · В разработке</p>
      <p style="font-size:.9375rem;color:var(--color-text-faint);margin-bottom:2rem;line-height:1.6">
        Этот модуль ещё не разработан.<br>
        Студент: замени <code style="background:var(--color-surface-offset);padding:2px 6px;border-radius:4px;font-size:.875rem">attendance/index.php</code> своим кодом.
      </p>
