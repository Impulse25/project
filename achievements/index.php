...
<head>
  ...
  <title>Достижения — СВГТК Портал</title>
...
<aside class="sidebar" id="sidebar">
  <div class="sidebar-header">
    <div class="logo">
      ...
      <div class="logo-text"><span class="logo-title">СВГТК Портал</span><span class="logo-sub">Достижения</span></div>
    </div>
  ...
  <nav class="sidebar-nav">
    ...
    <a href="../achievements/" class="nav-item active">
...
<div class="main-wrapper" id="mainWrapper">
  ...
  <main class="page-content" style="display:flex;align-items:center;justify-content:center;min-height:calc(100vh - var(--topbar-height))">
    <div style="text-align:center;max-width:480px">
      <div style="width:80px;height:80px;border-radius:20px;background:#ca8a0420;display:flex;align-items:center;justify-content:center;margin:0 auto 1.5rem">
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#ca8a04" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89L17 22l-5-3-5 3 1.523-9.11"/></svg>
      </div>
      <h1 style="font-family:var(--font-display);font-size:1.75rem;font-weight:700;color:var(--color-text);margin-bottom:.75rem">Достижения</h1>
      <p style="font-size:1rem;color:var(--color-text-muted);margin-bottom:.5rem">Тема 3 · В разработке</p>
      <p style="font-size:.9375rem;color:var(--color-text-faint);margin-bottom:2rem;line-height:1.6">
        Этот модуль ещё не разработан.<br>
        Студент: замени <code style="background:var(--color-surface-offset);padding:2px 6px;border-radius:4px;font-size:.875rem">achievements/index.php</code> своим кодом.
      </p>
