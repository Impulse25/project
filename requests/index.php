...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        // login() сам разберётся: LDAP или локальная БД — в зависимости от LDAP_ACTIVE
...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
            ...
            <?php if (defined('LDAP_ACTIVE') && LDAP_ACTIVE): ?>
            <div class="mt-4 text-center text-xs text-green-600">
                <i class="fas fa-network-wired"></i> <?php echo t('ldap_active'); ?>
            </div>
            <?php endif; ?>
