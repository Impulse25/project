...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="bg-white shadow-sm border-b no-print">
        <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center gap-3">
                <a href="print_request.php?id=<?php echo $requestId; ?>" target="_blank" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 no-print">
                    ...
                    <div class="space-y-2">
                        <a href="print_request.php?id=<?php echo $requestId; ?>" target="_blank" class="w-full px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition text-left block">
                            <i class="fas fa-print mr-2"></i>
                            Печать заявки
                        </a>
