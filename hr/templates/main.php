  ...
  <main class="page-content">
    ...
    <div class="page-header">
      <div>
        ...
        <p class="page-subtitle">Трудоустройство выпускников · <?= $total ?> студентов</p>
      </div>
          ...
          <div class="filters-bar">
            ...
            <div class="form-group">
              ...
              <select name="group_id" class="form-control">
                ...
                <option value="<?= $g['id'] ?>" <?= $fGroup === $g['id'] ? 'selected' : '' ?>>
            ...
            <div class="form-group">
              ...
              <select name="specialty_id" class="form-control">
                ...
                <option value="<?= $sp['id'] ?>" <?= $fSpec === $sp['id'] ? 'selected' : '' ?>>
          ...
          <table class="data-table">
            <thead>
              <tr>
                ...
                <th>Дата</th>
                <th style="text-align:center">По спец.</th>
                <th style="text-align:center">Справки</th>
              ...
              <tr>
                ...
                <td style="text-align:center">
                  <?php if($row['status'] === 'employed'): ?>
                    <?= $row['is_by_specialty'] ? '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-success)" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg>' : '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-error)" stroke-width="2.5"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>' ?>
                  <?php else: ?>
                  <span style="color:var(--color-text-faint)">—</span>
                  <?php endif ?>
                </td>
