...
<?php
$activeModule = 'hr'; // achievements / analytics / hr / umr / qr
$moduleTitle  = 'HR-аналитика'; // Достижения / Аналитика / HR-аналитика / УМР / QR-посещаемость
...
<div class="main-wrapper" id="mainWrapper">
  ...
  <main class="page-content" style="display:flex;align-items:center;justify-content:center;min-height:calc(100vh - var(--topbar-height))">
    <div style="text-align:center;max-width:480px">
      <div style="width:80px;height:80px;border-radius:20px;background:#db277720;display:flex;align-items:center;justify-content:center;margin:0 auto 1.5rem">
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#db2777" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
      </div>
      <h1 style="font-family:var(--font-display);font-size:1.75rem;font-weight:700;color:var(--color-text);margin-bottom:.75rem">HR-аналитика</h1>
      <p style="font-size:1rem;color:var(--color-text-muted);margin-bottom:.5rem">Тема 5 · В разработке</p>
      <p style="font-size:.9375rem;color:var(--color-text-faint);margin-bottom:2rem;line-height:1.6">
        Этот модуль ещё не разработан.<br>
        Студент: замени <code style="background:var(--color-surface-offset);padding:2px 6px;border-radius:4px;font-size:.875rem">hr/index.php</code> своим кодом.
      </p>
