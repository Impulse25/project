...
// Если страница модуля передала внутренний ключ вроде grade_sheets,
// всё равно подсвечиваем основной пункт «Учебный процесс».
$knownExternalNav = ['requests', 'admin'];
if (!isset($navItems[$activeNav]) && !isset($modules[$activeNav]) && !in_array($activeNav, $knownExternalNav, true)) {
    $activeNav = 'edu';
}
?>
